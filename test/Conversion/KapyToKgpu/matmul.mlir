...
module attributes {kapy.num_warps = 4 : i64, kapy.nvidia_cc = 89 : i64} {
  kapy.func @matmul_kernel(%arg0: i64 {kapy.alignment = 128 : i64}, %arg1: i64 {kapy.alignment = 128 : i64}, %arg2: i64 {kapy.alignment = 128 : i64}, %arg3: i32 {kapy.alignment = 1 : i64}, %arg4: i32 {kapy.alignment = 1 : i64}, %arg5: i32 {kapy.alignment = 1 : i64}, %arg6: i32 {kapy.alignment = 1 : i64}, %arg7: i32 {kapy.alignment = 1 : i64}, %arg8: i32 {kapy.alignment = 1 : i64}, %arg9: i32 {kapy.alignment = 1 : i64}, %arg10: i32 {kapy.alignment = 1 : i64}, %arg11: i32 {kapy.alignment = 1 : i64}) {
    ...
    %0 = kapy.mk_global %arg0, shape = [%arg3, %arg4], strides = [%arg9, %c1_i32] : tensor<?x?xf16, #global>
    %1 = kapy.mk_global %arg1, shape = [%arg5, %arg6], strides = [%arg10, %c1_i32] : tensor<?x?xf16, #global>
    %2 = kapy.mk_global %arg2, shape = [%arg7, %arg8], strides = [%arg11, %c1_i32] : tensor<?x?xf16, #global>
    %3 = kapy.mk_shared strides = [64, 1] : tensor<128x64xf16, #shared>
    %4 = kapy.mk_shared strides = [128, 1] : tensor<64x128xf16, #shared>
    %5 = kapy.mk_shared strides = [64, 1] : tensor<128x64xf16, #shared>
    %6 = kapy.mk_shared strides = [128, 1] : tensor<64x128xf16, #shared>
    ...
    %31 = kapy.sv_shared %27[%c0_i32 : %c16_i32, %c0_i32 : %c64_i32] : tensor<64x64xf16, #shared> -> tensor<16x64xf16, #shared>
    %32 = kapy.ld_matrix %30, %cst_0 : tensor<64x16xf16, #shared>, tensor<64x16xf16, #values> -> tensor<64x16xf16, #values>
    %33 = kapy.ld_matrix %31, %cst_1 : tensor<16x64xf16, #shared>, tensor<16x64xf16, #values> -> tensor<16x64xf16, #values>
    %34:3 = scf.for %arg12 = %c2_i32 to %c16_i32 step %c1_i32 iter_args(%arg13 = %32, %arg14 = %33, %arg15 = %cst) -> (tensor<64x16xf16, #values>, tensor<16x64xf16, #values>, tensor<64x64xf16, #values>)  : i32 {
      ...
      %75 = arith.select %73, %27, %29 : tensor<64x64xf16, #shared>
      %76 = kapy.sv_shared %74[%c0_i32 : %c64_i32, %c16_i32 : %c32_i32] : tensor<64x64xf16, #shared> -> tensor<64x16xf16, #shared>
      %77 = kapy.sv_shared %75[%c16_i32 : %c32_i32, %c0_i32 : %c64_i32] : tensor<64x64xf16, #shared> -> tensor<16x64xf16, #shared>
      %78 = kapy.ld_matrix %76, %cst_0 : tensor<64x16xf16, #shared>, tensor<64x16xf16, #values> -> tensor<64x16xf16, #values>
      %79 = kapy.ld_matrix %77, %cst_1 : tensor<16x64xf16, #shared>, tensor<16x64xf16, #values> -> tensor<16x64xf16, #values>
      ...
      %82 = kapy.sv_shared %75[%c32_i32 : %c48_i32, %c0_i32 : %c64_i32] : tensor<64x64xf16, #shared> -> tensor<16x64xf16, #shared>
      %83 = kapy.ld_matrix %81, %cst_0 : tensor<64x16xf16, #shared>, tensor<64x16xf16, #values> -> tensor<64x16xf16, #values>
      %84 = kapy.ld_matrix %82, %cst_1 : tensor<16x64xf16, #shared>, tensor<16x64xf16, #values> -> tensor<16x64xf16, #values>
      ...
      %87 = kapy.sv_shared %75[%c48_i32 : %c64_i32, %c0_i32 : %c64_i32] : tensor<64x64xf16, #shared> -> tensor<16x64xf16, #shared>
      %88 = kapy.ld_matrix %86, %cst_0 : tensor<64x16xf16, #shared>, tensor<64x16xf16, #values> -> tensor<64x16xf16, #values>
      %89 = kapy.ld_matrix %87, %cst_1 : tensor<16x64xf16, #shared>, tensor<16x64xf16, #values> -> tensor<16x64xf16, #values>
      ...
      %96 = arith.select %73, %29, %27 : tensor<64x64xf16, #shared>
      %97 = kapy.sv_shared %95[%c0_i32 : %c64_i32, %c0_i32 : %c16_i32] : tensor<64x64xf16, #shared> -> tensor<64x16xf16, #shared>
      %98 = kapy.sv_shared %96[%c0_i32 : %c16_i32, %c0_i32 : %c64_i32] : tensor<64x64xf16, #shared> -> tensor<16x64xf16, #shared>
      %99 = kapy.ld_matrix %97, %cst_0 : tensor<64x16xf16, #shared>, tensor<64x16xf16, #values> -> tensor<64x16xf16, #values>
      %100 = kapy.ld_matrix %98, %cst_1 : tensor<16x64xf16, #shared>, tensor<16x64xf16, #values> -> tensor<16x64xf16, #values>
    ...
    %36 = kapy.sv_shared %27[%c16_i32 : %c32_i32, %c0_i32 : %c64_i32] : tensor<64x64xf16, #shared> -> tensor<16x64xf16, #shared>
    ...
    %41 = kapy.sv_shared %27[%c32_i32 : %c48_i32, %c0_i32 : %c64_i32] : tensor<64x64xf16, #shared> -> tensor<16x64xf16, #shared>
    ...
    %46 = kapy.sv_shared %27[%c48_i32 : %c64_i32, %c0_i32 : %c64_i32] : tensor<64x64xf16, #shared> -> tensor<16x64xf16, #shared>
    ...
    %51 = kapy.sv_shared %29[%c0_i32 : %c16_i32, %c0_i32 : %c64_i32] : tensor<64x64xf16, #shared> -> tensor<16x64xf16, #shared>
    ...
    %56 = kapy.sv_shared %29[%c16_i32 : %c32_i32, %c0_i32 : %c64_i32] : tensor<64x64xf16, #shared> -> tensor<16x64xf16, #shared>
    ...
    %61 = kapy.sv_shared %29[%c32_i32 : %c48_i32, %c0_i32 : %c64_i32] : tensor<64x64xf16, #shared> -> tensor<16x64xf16, #shared>
    ...
    %66 = kapy.sv_shared %29[%c48_i32 : %c64_i32, %c0_i32 : %c64_i32] : tensor<64x64xf16, #shared> -> tensor<16x64xf16, #shared>
