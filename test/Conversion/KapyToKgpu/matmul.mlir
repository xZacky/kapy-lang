...
module {
  kapy.func @matmul_kernel(%arg0: !kapy.ptr<1>, %arg1: !kapy.ptr<1>, %arg2: !kapy.ptr<1>) {
    ...
    %2 = kapy.get_memref %arg0, [%c128_i32, %c128_i32], [%c128_i32, %c1_i32] : !kapy.ptr<1> -> !kapy.memref<64x64xf16, #glmem>
    %3 = arith.muli %0, %c8192_i32 : i32
    %4 = kapy.mov_memref %2, %3 : !kapy.memref<64x64xf16, #glmem>
    %5 = kapy.get_memref %arg1, [%c128_i32, %c128_i32], [%c128_i32, %c1_i32] : !kapy.ptr<1> -> !kapy.memref<64x64xf16, #glmem>
    %6 = arith.muli %1, %c64_i32 : i32
    %7 = kapy.mov_memref %5, %6 : !kapy.memref<64x64xf16, #glmem>
    ...
    %8:3 = scf.for %arg3 = %c0_i32 to %c2_i32 step %c1_i32 iter_args(%arg4 = %cst, %arg5 = %4, %arg6 = %7) -> (tensor<64x64xf32>, !kapy.memref<64x64xf16, #glmem>, !kapy.memref<64x64xf16, #glmem>) : i32 {
      ...
      %18 = kapy.mov_memref %arg5, %c64_i32 : !kapy.memref<64x64xf16, #glmem>
      %19 = kapy.mov_memref %arg6, %c8192_i32 : !kapy.memref<64x64xf16, #glmem>
    ...
    %10 = kapy.get_memref %arg2, [%c128_i32, %c128_i32], [%c128_i32, %c1_i32] : !kapy.ptr<1> -> !kapy.memref<64x64xf16, #glmem>
    %11 = arith.muli %0, %c8192_i32 : i32
    %12 = arith.muli %1, %c64_i32 : i32
    %13 = arith.addi %11, %12 : i32
    %14 = kapy.mov_memref %10, %13 : !kapy.memref<64x64xf16, #glmem>
